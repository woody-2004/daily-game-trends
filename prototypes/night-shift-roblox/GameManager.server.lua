...
local IMPORTED_ASSETS = {
	...
	environments = {
		...
		{ id = 112181051620055, zone = "Hall", name = "CampHouse", pos = Vector3.new(0, 0, 0), footprint = 52, yaw = 180 }, -- "camp house" (Discussion Hall)
		{ id = 101577288469591, zone = "Barn", name = "FarmHouseAndLake", pos = Vector3.new(66, 0, -64), footprint = 58, yaw = 0 }, -- "farm house and lake"
		{ id = 89317303583763, zone = "Factory", name = "TerrainDiorama", pos = Vector3.new(80, 0, 42), footprint = 62, yaw = 0 }, -- "terrain"
		{ id = 131157036777467, zone = "Warehouse", name = "OldCasaDeSin", pos = Vector3.new(-78, 0, -68), footprint = 58, yaw = 0 }, -- "old casa de sin"
		{ id = 0, zone = "Junkyard", name = "ForestLoner", pos = Vector3.new(-82, 0, 30), footprint = 46, yaw = 0 }, -- (no import yet: keeps the wrecked trucks)
	},
}
